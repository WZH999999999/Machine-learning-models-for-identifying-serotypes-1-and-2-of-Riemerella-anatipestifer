#The model for idendnetifing serotypes 1 and 2 of Riemerella anatipestifer using Random Forest algorithm
import numpy as np
import pandas as pd
import os
...
rfcc=RandomForestClassifier(random_state=150)
model_one=rfcc.fit(train_x,train_y)
